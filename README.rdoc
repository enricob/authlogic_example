...
2. I will soon be writing a blog post which fully explains how <tt>LdapUser</tt> and <tt>LdapGroup</tt> are associated
with each other. For now, refer to the {ActiveLdap documentation}[http://ruby-activeldap.rubyforge.org/doc/].
