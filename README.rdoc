...
3. There is a new DB migration in this branch which adds an "email" column to the users table. In this context, there's no sense in editing the user's login and password, so we need some piece of information to edit for the sake of demonstrating the difference between admins and regular users.
